...
# ╔═╡ 13aa75f8-8c36-4303-955b-d3705618ec6f
using LinearAlgebra, RxInfer, Plots, PGFPlotsX, LogExpFunctions, PlutoUI

# ╔═╡ 620e2174-f1a8-11ef-220f-9f125a2ff79e
md"
## Door
"

# ╔═╡ 7b21e049-f744-44a2-81ef-d6df27dffff0
begin
...
# ╔═╡ 82c65299-52b7-4a59-9717-8a7fb246bfe4
md"Save figures $(@bind save_figures CheckBox(default=false))"

# ╔═╡ 934a4f2d-adaf-4069-b1f0-50f62b8f5867
if save_figures
	mkpath("exports")
	nothing
end

# ╔═╡ c6d7c1ae-2905-4655-9ea4-3c2ae847ab07
md"""
## Problem sketch
"""

# ╔═╡ a97c8c81-d3b3-4052-96db-0c38e56b9a03
begin
	goals = hcat([
...
# ╔═╡ 91e25846-da6b-4fa4-ad0c-bf2978c75177
begin
	plot(size = (600, 600))
...
# ╔═╡ 04a2a654-1496-4791-b175-f8f1994a52e7
md"""
## Halfspace prior implementation
"""

# ╔═╡ 616e9a59-1eb4-40c8-8c5e-ae35035dd9de
begin
...
# ╔═╡ e223e5a7-fac4-4c2b-b46d-e8c2e164258c
md"""
## Model specification 
"""

# ╔═╡ b2459a57-ad2b-4b34-8c6f-89e4c5f4990e
function g(y; r = radius)
	return distance(environment, y) - r
end;

# ╔═╡ cbe2745f-05da-41d8-b742-3f893639b2e1
...
# ╔═╡ 52e040f5-844f-4154-9a0c-ac0b8f22725b
md"""
## Constraint specification
"""

# ╔═╡ 9af96408-d6cf-41fb-b674-ead7dc4ecb65
@constraints function door_constraints()
	q(d, dσ2) = q(d)q(dσ2)
	q(z, zσ2) = q(z)q(zσ2)
end;

# ╔═╡ 95ac5a26-7ea6-4ad6-9a64-fcda373f9136
md"""
## Probabilistic inference
"""

# ╔═╡ ec9dec69-f007-4a7e-b894-21aaa6a50c1a
door_meta = @meta begin 
    h() -> Linearization(),
	g() -> Linearization()
end;

# ╔═╡ cd053cde-e2f5-425b-8249-7e92d00db938
nr_steps = 50
...
manifest_format = "2.0"
project_hash = "09af900c993d177e76c59142282c25f2d137f265"
